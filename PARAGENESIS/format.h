...
#define IN_VARS &Totalexperiments,&Totaltrials,&Pop_temp,&Length_temp,\
	&C_rate,&M_rate,&Gapsize,\
	&Window_temp,&Interval,\
	&Save_temp,&Maxspin,\
	&Dump_freq,&Num_dumps,\
	Options,\
	&OrigSeed, &Rank_min
...
#define OUT_VARS Totalexperiments,Totaltrials,Pop_temp,Length_temp,\
	C_rate,M_rate,Gapsize,\
	Window_temp,Interval,Save_temp,Maxspin,\
