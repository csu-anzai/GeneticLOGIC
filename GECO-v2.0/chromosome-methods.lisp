...
(defmethod SWAP-ALLELES ((self chromosome) &KEY
                         (locus-index (pick-locus-index self))
...
(defmethod SHARED-INITIALIZE :AFTER
                               ((self gray-code-translation) slot-names &REST initargs
...
(defmethod PMX-CROSS-CHROMOSOMES ((parent1 sequence-chromosome)
                                  ...
                                  &KEY
                                  (locus-index1 (pick-locus-index parent1))
                                  (locus-index2 (pick-locus-index parent1))
                                  (allele-test #'eql)
                                  &AUX
                                  (n (size parent1))
