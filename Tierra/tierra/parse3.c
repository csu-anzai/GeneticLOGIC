/* parse3.c   9-9-92  parser functions for instruction set 3 */
/* Tierra Simulator V4.0: Copyright (c) 1991, 1992 Tom Ray & Virtual Life */

#if INST == 3

/* in INST == 3, the array of registers maps into the registers ax, bx, cx, dx
 ...
 * is.sval2 = original value of destination instruction
 */
void pmovii(ce) /* soup [AX] = soup [BX] */
Pcells  ce;
{   I32s  tval;
 ...
 */
void ppush(ce) /* push AX onto stack */
Pcells  ce;
{   I32s  tval;
 ...
 * is.dran = range within which to contain destination register
 */
void ppop(ce) /* pop AX off of stack */
Pcells  ce;
{   I32s  tval;
