...
/* rand48.c -- rand48(3) random number generator routines
...
#ifndef lint
static char *rcsid = "$Id: rand48.c,v 1.1 1993/10/04 12:00:09 joke Exp $";
#endif
     ...
     int batchflag;
{
  ...
  srand48 ((long) (randomseed * 100000.0));
}
